...
(function($  ){
      ...
      * @param {string} options.remoteURL - URL to POST to on save
      * @param {string} options.cssInclude - URL to external CSS file to load (i.e font awesome)
      * @param {string} options.canvasId - The ID of the main interal canvas as generated by Gridmanager
      * @param {string} options.controlId - The ID of the main control bar as generated by Gridmanager
      * @param {array} options.controlButtons - Array of button widths, i.e [[12],[6-6]] which are then autogenerated in the top control bar
      * @param {object} options.customControls - Array of objects for custom controls
          * @param {object} options.customControls.global_row - For custom buttons on a row control
            * @param {string} options.customControls.global_row.callback - Name of custom callback function (required)
            * @param {string} options.customControls.global_row.loc - Location of custom callback function button, options are bottom or top
            * @param {string} options.customControls.global_row.iconClass - css class of icon for custom callback function button, i.e fa fa-myicon
            * @param {string} options.customControls.global_row.btnClass - css class of button for custom callback function button
          * @param {object} options.customControls.global_col - For custom buttons on a column control 
            * @param {string} options.customControls.global_col.callback - Name of custom callback function (required)
            * @param {string} options.customControls.global_col.loc - Location of custom callback function button, options are bottom or top
            * @param {string} options.customControls.global_col.iconClass - css class of icon for custom callback function button, i.e fa fa-myicon
            * @param {string} options.customControls.global_col.btnClass - css class of button for custom callback function button
      * @param {string} options.controlButtonClass - Default control bar button class
      * @param {string} options.controlButtonSpanClass - Default control bar button icon class
      * @param {string} options.controlAppend - Control bar markup for main controls
      * @param {string} options.gmEditClass - Standard Edit Calss, Applied to active elements
      * @param {string} options.gmEditClassSelected - Applied to the currently selected element
      * @param {string} options.gmEditRgion - Editable Region Class, i.e what RTEs get attached to
      * @param {string} options.gmToolClass - Tool bar class which are inserted dynamically
      * @param {string} options.gmClearClass - Clearing class to fix floats, used on most toolbars
      * @param {string} options.gmFloatLeft - Generic Float Left
      * @param {string} options.gmFloatRight - Generic Float Right
      * @param {string} options.gmBtnGroup - Generic Button Group Class
      * @param {string} options.gmDangerClass - Generic Class to indicate active button 
      * @param {string} options.rowClass - Generic row class. change to row--fluid for fluid width in Bootstrap
      * @param {string} options.rowSelector - Used to find rows - change to div.row-fluid for fluid width
      * @param {string} options.rowSortingClass - class of background element when sorting rows
      * @param {object} options.rowButtonsPrepend - Buttons at the top of each row
          * @param {string} options.rowButtonsPrepend.title - Title for button
          * @param {string} options.rowButtonsPrepend.element - Element to generate, i.e a
          * @param {string} options.rowButtonsPrepend.btnClass - Class for the button
          * @param {string} options.rowButtonsPrepend.iconClass - Class for the button icon   
      * @param {object} options.rowButtonsAppend - Buttons at the bottom of each row
          * @param {string} options.rowButtonsAppend.title - Title for button
          * @param {string} options.rowButtonsAppend.element - Element to generate, i.e a
          * @param {string} options.rowButtonsAppend.btnClass - Class for the button
          * @param {string} options.rowButtonsAppend.iconClass - Class for the button icon    
      * @param {string} options.rowSettingControls - Ignore this, probably will be deprecated
      * @param {array} options.rowCustomClasses - Custom row classes - add your own to make them available in the row settings, i.e ["one","two"]
      * @param {string} options.colClass - Generic column class
      * @param {boolean} options.addResponsiveClasses - Adds any missing classes in columns for muti-device support
      * @param {string} options.colDesktopClass - Generic desktop size layout class
      * @param {string} options.colTabletClass - Generic tablet size layout class
      * @param {string} options.colPhoneClass - Generic phone size layout class
      * @param {string} options.colDesktopSelector - Wild card column desktop selector
      * @param {string} options.colTabletSelector - Wildcard column tablet selector
      * @param {string} options.colPhoneSelector - Wildcard column phone selector
      * @param {string} options.classRenameSuffix - String used to temporarily rename column classes not in use
      * @param {string} options.layoutDefaultMode - Default layout mode loaded after init
      * @param {string} options.currentClassMode - Current layout column mode
      * @param {string} options.colAdditionalClass - Additional column class to add (foundation needs columns, bs3 doesn't)
       * @param {object} options.colButtonsPrepend - Buttons at the top of each col
          * @param {string} options.colButtonsPrepend.title - Title for button
          * @param {string} options.colButtonsPrepend.element - Element to generate, i.e a
          * @param {string} options.colButtonsPrepend.btnClass - Class for the button
          * @param {string} options.colButtonsPrepend.iconClass - Class for the button icon   
      * @param {object} options.colButtonsAppend - Buttons at the bottom of each col
          * @param {string} options.colButtonsAppend.title - Title for button
          * @param {string} options.colButtonsAppend.element - Element to generate, i.e a
          * @param {string} options.colButtonsAppend.btnClass - Class for the button
          * @param {string} options.colButtonsAppend.iconClass - Class for the button icon   
      * @param {array} options.colCustomClasses - Custom column classes - add your own to make them available in the col settings, i.e ["one","two"]
      * @param {integer} options.colMax - Maximum column span value: if you've got a 24 column grid via customised bootstrap, you could set this to 24.
      * @param {integer} options.colResizeStep - Column resizing +- value: this is also the colMin value, as columns won't be able to go smaller than this number (otherwise you hit zero and all hell breaks loose)
      * @param {object} options.tinymce - Custom TinyMCE Configuration
      * @param {object} options.tinymce.config - Custom TinyMCE Configuration config struct (see tinyMCE documentation)
      * @param {object} options.ckeditor - Custom CKEditor Configuration
      * @param {string} options.ckeditor.customConfig - Path to ckeditor external custom configuration file: note, relative path is relative to your ckeditor.js file, not the page;
     * @returns gridmanager
     * @class gridmanager
     * @memberOf jQuery.fn
     */
